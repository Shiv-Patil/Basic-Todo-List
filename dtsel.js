(function () {
    ...
    */
    ...
    DTBox.prototype.onDateSelected = function (e) {
        ...
        if(this.year < this.initial.getFullYear()){
            myFunction()
            return
        }
        if(this.month < this.initial.getMonth() && this.year === this.initial.getFullYear()){
            myFunction()
            return
        }
        if(this.month === this.initial.getMonth() && this.initial.getDate() > this.day) {
            myFunction()
            return
        }
    ...
    DTBox.prototype.onMonthSelected = function (e) {
        ...
        if(this.month < this.initial.getMonth() && this.initial.getFullYear() === this.year) {
            myFunction()
            return
        }
        this.bodyType = "DAYS";
    ...
    DTBox.prototype.onHeaderChange = function (e) {
        ...
        if (cell.previousSibling && cell.nextSibling) {
            ...
            switch (this.bodyType) {
                case "DAYS":
                    this.month += sign * 1;
                    if(this.month < this.initial.getMonth()) {
                        this.month += 1
                    }
                    break;
                case "MONTHS":
